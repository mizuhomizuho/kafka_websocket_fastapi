...
Брокеры различаются по:
По методу хранения персистентного состояния (в памяти или на жестком диске)
По методу push и по методу pull (сам ходишь за сообщениями или брокер уведомляет)
